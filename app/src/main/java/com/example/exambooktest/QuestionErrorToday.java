...
public class QuestionErrorToday extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //更新答题界面的碎片
//        replaceFragment(new QuestionAnswer());
//
    ...
    private void initdata() {
        ErrorQuestion errorQuestion = new ErrorQuestion(studentId, new ErrorQuestion.CallBack() {
            @Override
            public void onResult(List<QuestionBank> questionBanksAll,List<QuestionBank> questionBanksToday) {
                Log.d(TAG, "ViewPagerAdapter: "  + questionBanks.size() );
//                Log.d(TAG, "ViewPagerAdapter: "  + qb.get(0).getTitle() );
                questionBanks.clear();
                questionBanks.addAll(questionBanksToday);
    ...
    private void initPager() {
        ...
        //回调
        viewPagerAdapter = new ViewPagerAdapter(QuestionErrorToday.this, new ArrayList<>(), new ViewPagerAdapter.CallBack() {
            @Override
