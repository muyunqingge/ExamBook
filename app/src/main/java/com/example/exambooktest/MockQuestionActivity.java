...
import com.example.exambooktest.ui.practice.PracticeFragment;
 ...
 * 模拟考试
 */
public class MockQuestionActivity extends AppCompatActivity implements View.OnClickListener{
...
//                Log.d(TAG, "ViewPagerAdapter: "  + qb.get(0).getTitle() );
    ...
    private void initPager() {
        ...
        //回调
        viewPagerAdapter = new ViewPagerAdapter(MockQuestionActivity.this, new ArrayList<>(), new ViewPagerAdapter.CallBack() {
            @Override
