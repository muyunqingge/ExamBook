...
import com.example.exambooktest.utils.ExamScores;
...
public class ExamSchoolReportActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "ExamSchoolReportActivit";
    ...
    private void initData() {
        ...
        ExamScores scores = new ExamScores(studentId, new ExamScores.CallBack() {
            @Override
...
//                startActivity(intent);
                ExamSchoolReportActivity.this.finish();
                break;
            default:
                break;
        }
