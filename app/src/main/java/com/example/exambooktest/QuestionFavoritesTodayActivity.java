...
import com.example.exambooktest.utils.FavoriteQuestionToday;
...
public class QuestionFavoritesTodayActivity extends AppCompatActivity implements View.OnClickListener {
...
//    }
    ...
    private void initdata() {
        //获得收藏题的数据
        FavoriteQuestionToday favoriteQuestion = new FavoriteQuestionToday(studentId, new FavoriteQuestionToday.CallBack() {
            @Override
...
//                Log.d(TAG, "ViewPagerAdapter: "  + qb.get(0).getTitle() );
    ...
    private void initPager() {
        ...
        //回调
        viewPagerAdapter = new ViewPagerAdapter(QuestionFavoritesTodayActivity.this, new ArrayList<>(), new ViewPagerAdapter.CallBack() {
